...
export const id: TranslationMap = {
  ...
  modelSetup: {
    ...
    manual: {
      ...
      verifyHint: "OpenClaw memverifikasi balasan model nyata sebelum menandai koneksi siap.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktifkan penjaga rolling-history yang memperingatkan atau memblokir panggilan alat berulang ketika agen berhenti membuat kemajuan.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "mendefragmentasi lorong memori…",
  ...
  chat: {
    ...
    composer: {
      ...
      menu: {
        ...
        addMcpServerDescription: "Konfigurasikan server dan pilih tempat mengaktifkannya.",
        scopeLabel: "Ketersediaan",
        scopeSession: "Sesi ini",
        scopeEverywhere: "Di mana saja",
        scopeSessionHint:
          "Server disimpan dinonaktifkan secara global dan hanya diaktifkan untuk sesi ini.",
