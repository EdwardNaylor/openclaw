...
export const nl: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Het updateverzoek is mogelijk geaccepteerd, maar de Gateway heeft na het opnieuw verbinden geen definitief resultaat gemeld. Voer `openclaw update status` uit voordat u het opnieuw probeert.",
    failureReasons: {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} heeft geen bruikbaar lokaal model beschikbaar gesteld. Bekijk het instelresultaat en probeer het opnieuw.",
    },
    manual: {
    ...
    success: {
      ...
      body: "OpenClaw heeft een echt antwoord ontvangen van {modelRef}. U kunt nu beginnen met chatten.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Schakel rollende-geschiedenisbeveiligingen in die waarschuwen voor of herhaalde toolaanroepen blokkeren wanneer een agent geen voortgang meer maakt.",
    },
    localModelLean: {
