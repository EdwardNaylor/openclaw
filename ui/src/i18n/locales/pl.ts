...
export const pl: TranslationMap = {
  ...
  configForm: {
    ...
    draftRejected: "Nie udało się zapisać tego ustawienia. Twoja wersja robocza jest nadal tutaj.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} nie udostępnił użytecznego lokalnego modelu. Przejrzyj wynik konfiguracji, a następnie spróbuj ponownie.",
    },
    manual: {
    ...
    success: {
      ...
      body: "OpenClaw otrzymał rzeczywistą odpowiedź od {modelRef}. Możesz teraz zacząć rozmawiać.",
  ...
  mcpServers: {
    ...
    sessionChanged: "Aktywna sesja zmieniła się, zanim udało się ją włączyć.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Włącz zabezpieczenia oparte na przesuwającej się historii, które ostrzegają lub blokują powtarzające się wywołania narzędzi, gdy agent przestaje robić postępy.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "defragmentacja ścieżek pamięci…",
