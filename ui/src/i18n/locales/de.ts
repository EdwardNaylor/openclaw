...
export const de: TranslationMap = {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "Die Web-App funktioniert bereits. Füge einen Kanal nur hinzu, wenn du OpenClaw von einem anderen Dienst aus schreiben möchtest.",
  ...
  mcpServers: {
    ...
    sessionChanged: "Die aktive Sitzung wurde geändert, bevor sie aktiviert werden konnte.",
    sessionUnavailable:
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Aktiviere Verlaufsprüfungen, die wiederholte Tool-Aufrufe warnen oder blockieren, wenn ein Agent keine Fortschritte mehr macht.",
    },
    localModelLean: {
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      signedInNoModels:
        "Du bist angemeldet, aber dieses Konto bietet keine nutzbaren Modelle. Wähle einen anderen Anbieter oder ein anderes Konto, um fortzufahren.",
    ...
    composer: {
      ...
      menu: {
        ...
        addMcpServerDescription:
          "Konfigurieren Sie den Server und wählen Sie, wo er aktiviert ist.",
