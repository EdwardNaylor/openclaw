...
export const tr: TranslationMap = {
  ...
  configForm: {
    ...
    invalidString: "Bu ayarın kısıtlamalarıyla eşleşen bir değer girin.",
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupBody:
        "Web uygulaması zaten çalışıyor. Yalnızca OpenClaw'a başka bir hizmetten mesaj göndermek isterseniz bir kanal ekleyin.",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Sunucu genel olarak devre dışı olarak kaydedildi, ancak bu oturum için etkinleştirilmesi başarısız oldu: {error}",
    sessionChanged: "Etkinleştirilmeden önce etkin oturum değişti.",
    sessionUnavailable: "Etkin oturum kullanılamıyor; sayfayı yenileyip tekrar deneyin.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Bir aracı ilerleme kaydetmeyi bıraktığında tekrarlanan araç çağrılarını uyaran veya engelleyen kayan geçmiş korumalarını etkinleştirin.",
    },
    localModelLean: {
