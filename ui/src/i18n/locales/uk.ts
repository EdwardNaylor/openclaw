...
export const uk: TranslationMap = {
  ...
  configForm: {
    ...
    invalidJson: "Введіть коректний JSON перед виходом із цього поля.",
    ...
    draftRejected: "Не вдалося зберегти це налаштування. Ваш чернетковий варіант збережено.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      providerNotReady:
        "{provider} не надав придатної локальної моделі. Перегляньте результат налаштування, а потім повторіть спробу.",
    },
    manual: {
      ...
      verifyHint:
        "OpenClaw перевіряє реальну відповідь моделі перед позначенням підключення як готового.",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "Сервер збережено вимкненим глобально, але його ввімкнення для цієї сесії не вдалося: {error}",
    sessionChanged: "Активна сесія змінилася, перш ніж її вдалося ввімкнути.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Увімкніть захист на основі змінної історії, що попереджає або блокує повторні виклики інструментів, коли агент перестає просуватися.",
    },
    localModelLean: {
