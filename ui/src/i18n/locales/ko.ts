...
export const ko: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "업데이트 요청이 수락되었을 수 있지만, Gateway가 재연결 후 최종 결과를 보고하지 않았습니다. 다시 시도하기 전에 `openclaw update status`를 실행하세요.",
    failureReasons: {
  ...
  modelSetup: {
    ...
    success: {
      title: "AI가 준비되었습니다",
      body: "OpenClaw가 {modelRef}로부터 실제 응답을 받았습니다. 이제 채팅을 시작할 수 있습니다.",
      activeModel: "활성 모델",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "서버가 전역적으로 비활성화된 상태로 저장되었지만, 이 세션에서 활성화하는 데 실패했습니다: {error}",
  ...
  labsPage: {
    ...
    loopDetection: {
      title: "도구 루프 감지",
      description:
        "에이전트가 진행을 멈췄을 때 반복되는 도구 호출을 경고하거나 차단하는 롤링 히스토리 가드를 활성화합니다.",
    },
    localModelLean: {
      title: "로컬 모델용 경량 도구",
      description:
