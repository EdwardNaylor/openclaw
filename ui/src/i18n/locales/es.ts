...
export const es: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "Es posible que la solicitud de actualización se haya aceptado, pero el Gateway no informó un resultado final tras reconectarse. Ejecuta `openclaw update status` antes de volver a intentarlo.",
    failureReasons: {
  ...
  configForm: {
    ...
    invalidJson: "Ingresa un JSON válido antes de salir de este campo.",
    invalidString: "Ingresa un valor que cumpla con las restricciones de esta configuración.",
    invalidNumber: "Ingresa un valor dentro del rango y el paso permitidos.",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaButton: "Verificar y configurar",
      ollamaLabel: "Ollama",
    ...
    success: {
      ...
      stayHere: "Permanecer en la configuración",
  ...
  mcpServers: {
    ...
    sessionEnableFailed:
      "El servidor se guardó deshabilitado globalmente, pero no se pudo habilitarlo para esta sesión: {error}",
